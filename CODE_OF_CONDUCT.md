...
We as members, contributors, and maintainers of **BookHelper** pledge to
...
diverse, inclusive, and healthy community — and to keep the bar of technical
craft high without ever using it as a weapon.
...
- Focusing on what is best not just for us as individuals, but for the
  overall community and product.
- Assuming good intent, then verifying.
...
issues, pull requests, discussions, social media channels associated with
the project — and also applies when an individual is officially
...
reported to the project maintainers by emailing
**conduct@bookhelper.dev** (or, if that address is not yet active, by
contacting the repository owner privately via their GitHub profile).
...
communication with the community for a specified period of time. Public or
private interaction with the people involved is not allowed during this
period.
